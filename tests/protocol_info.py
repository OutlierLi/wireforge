...
CSG_FIELD_DEFAULTS = {
    ...
    "delay_time":   0x01,
    "task_status":  0x01,
    "task_info":    bytes([0x12,0x34,0x56,0x78,0x90,0x12,0x00]),
    "task_list":    bytes([0x01,0x02]),
    "task_data":    bytes([0x12,0x34,0x56,0x78,0x90,0x12,0x00,0x11,0x22,0x33]),
    "event_data":   bytes([0x01,0x02]),
    "slave_data":   bytes([0x01,0x02]),
    "file_info":    bytes([0x01,0x02,0x03]),
    "file_segment": bytes([0xAA,0xBB]),
    "vendor_code":  "AB",
    "chip_code":    "01",
    "version_date": "260621",
    "version":      "1020",
